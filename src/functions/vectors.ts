...
export const dotProduct = (vec1: number[], vec2: number[]) => reduce((a, val) => a + val, mult(vec1, vec2), 0);

export const unitDotProduct = (vec1: number[], vec2: number[]) => dotProduct(unitVec(vec1), unitVec(vec2));
